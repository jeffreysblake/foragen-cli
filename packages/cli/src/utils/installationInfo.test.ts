...
import { isGitRepository } from '@jeffreysblake/foragen-cli-core';
...
describe('getInstallationInfo', () => {
  ...
  it('should detect Homebrew installation via execSync', () => {
    ...
    expect(mockedExecSync).toHaveBeenCalledWith(
      'brew list -1 | grep -q "^foragen-cli$"',
      { stdio: 'ignore' },
    );
  ...
  it('should detect global pnpm installation', () => {
    const pnpmPath = `/Users/test/.pnpm/global/5/node_modules/.pnpm/some-hash/node_modules/@jeffreysblake/foragen-cli/dist/index.js`;
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('pnpm add -g @jeffreysblake/foragen-cli@latest');
  ...
  it('should detect global yarn installation', () => {
    const yarnPath = `/Users/test/.yarn/global/node_modules/@jeffreysblake/foragen-cli/dist/index.js`;
    ...
    expect(info.updateCommand).toBe(
      'yarn global add @jeffreysblake/foragen-cli@latest',
    );
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should detect global bun installation', () => {
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('bun add -g @jeffreysblake/foragen-cli@latest');
    expect(info.updateMessage).toContain('Attempting to automatically update');
