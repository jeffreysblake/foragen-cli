...
import type { IdeInfo } from '@jeffreysblake/foragen-cli-core';
...
export function IdeIntegrationNudge({
  ...
  const isExtensionPreInstalled =
    !!process.env['FORAGEN_CLI_IDE_SERVER_PORT'] &&
    ...
    >
      <Box marginBottom={1} flexDirection="column">
        <Text>
          ...
          {`Do you want to connect ${ideName ?? 'your editor'} to Foragen CLI?`}
        </Text>
