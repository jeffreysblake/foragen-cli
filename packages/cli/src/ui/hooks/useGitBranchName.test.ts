...
import { spawnAsync as mockSpawnAsync } from '@jeffreysblake/foragen-cli-core';

// Mock @jeffreysblake/foragen-cli-core
vi.mock('@jeffreysblake/foragen-cli-core', async () => {
  const original = await vi.importActual<
    typeof import('@jeffreysblake/foragen-cli-core')
