...
import type { Config, FileSearch } from '@jeffreysblake/foragen-cli-core';
import { FileSearchFactory } from '@jeffreysblake/foragen-cli-core';
import type { FileSystemStructure } from '@jeffreysblake/foragen-cli-test-utils';
