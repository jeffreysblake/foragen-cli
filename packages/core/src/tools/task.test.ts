  ...
  const mockSubagents: SubagentConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.fora/agents/file-search.md',
    },
    {
      name: 'code-review',
      ...
      level: 'user',
      filePath: '/home/user/.fora/agents/code-review.md',
    },
  ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.fora/agents/new-agent.md',
        },
      ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.fora/agents/test-agent.md',
        },
      ];
