...
export const DEFAULT_FORA_MODEL = 'coder-model';
export const DEFAULT_FORA_FLASH_MODEL = 'coder-model';
export const DEFAULT_FORA_EMBEDDING_MODEL = 'text-embedding-v4';
