...
describe('quotaErrorDetection', () => {
  describe('isForaQuotaExceededError', () => {
    ...
    it('should not detect throttling errors as quota exceeded', () => {
      ...
      expect(isForaQuotaExceededError(error)).toBe(false);
    });
  ...
  describe('isForaThrottlingError', () => {
    ...
    it('should not detect throttling without 429 status in structured error', () => {
      ...
      expect(isForaThrottlingError(error)).toBe(false);
    });
