...
Once added, the facts are stored under a `## Fora Added Memories` section. This file is loaded as context in subsequent sessions, allowing the CLI to recall the saved information.
...
```
save_memory(fact="The project I'm currently working on is called 'foragen-cli'.")
```
